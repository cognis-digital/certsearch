...
[![PyPI](https://img.shields.io/pypi/v/cognis-certsearch.svg)](https://pypi.org/project/cognis-certsearch/)
[![CI](https://github.com/cognis-digital/certsearch/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/certsearch/actions)
...
CERTSEARCH exists for one job — analyze certificate-transparency exports for subdomains & rogue issuance — and does it without a SaaS bill or heavyweight setup.
...
```bash
certsearch --version
certsearch scan .                      # scan the current project
certsearch scan . --format json
certsearch scan . --fail-on high       # non-zero exit for CI gates
certsearch mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **crt.sh**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`certsearch` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).

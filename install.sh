#!/usr/bin/env sh
# Universal installer for certsearch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/certsearch.git"
echo "Installing certsearch ..."

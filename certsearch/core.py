"""CERTSEARCH core — Analyze Certificate-Transparency exports for subdomains & rogue issuance."""
...
RULES = [
    ("CER-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CER-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CER-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
